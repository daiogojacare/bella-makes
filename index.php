...
<html lang="pt-br">
   ...
   <body>
         ...
         <div class="header_section">
            <div class="container">
               <div class="containt_main">
                  ...
                  <div class="dropdown">
                     <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Todas as Categorias 
                     </button>
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src="assets/images/flag-br.png" alt="flag" class="mr-2" title="Brasil" style="width: 20px; height: auto;"> Português <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="indexingles.php" class="dropdown-item">
                           <img src="assets/images/flag-us.png" class="mr-2" alt="flag" style="width: 20px; height: auto;">
                           Inglês
                           </a>
                        </div>
                     </div>
      ...
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text">© 2023 Todos os direitos reservados. Feito por <a href="https://github.com/daiogojacare">Diogo Borges Corso</a></p>
         </div>
      </div>
